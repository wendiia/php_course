...
assert(null == array_diff([0.85, -2.35], quadraticEquation(2, 3, -4)));
assert(null == array_diff([1, 0.5], quadraticEquation(2, -3, 1)));
assert(null == array_diff([3], quadraticEquation(1, -6, 9)));
